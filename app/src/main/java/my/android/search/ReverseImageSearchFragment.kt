...
class ReverseImageSearchFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        if (!resultLoaded) {
            activity?.intent.let {
                if (it?.hasExtra(Intent.EXTRA_STREAM) == true) {
    ...
    companion object {
        ...
        const val USER_AGENT_WEB = "Mozilla/5.0 (Windows NT 10.0; rv:91.0) Gecko/20100101 Firefox/91.0"
        const val USER_AGENT_PHONE = "Mozilla/5.0 (Android 10; Mobile; rv:91.0) Gecko/20100101 Firefox/91.0"
